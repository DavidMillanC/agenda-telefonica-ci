...
def test_agregar_contacto_valido_carlos():
    agenda = AgendaTelefonica()
    agenda.agregar_contacto("Carlos", "0998755432")
    assert agenda.obtener_contacto("Carlos") == "0998755432"


def test_agregar_contacto_valido_david():
    agenda = AgendaTelefonica()
